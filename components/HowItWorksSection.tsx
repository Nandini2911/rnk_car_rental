      ...
      <div className="max-w-6xl mx-auto px-6 relative">
        ...
        >
          <motion.div variants={itemVariants}>
            <p className="text-xs tracking-[0.3em] uppercase text-red-900 mb-2">
              How It Works
            </p>
            <h2 className="text-3xl md:text-4xl font-semibold leading-tight text-black">
              A Seamless Journey,
              <br className="hidden md:block" />
              <span className="text-red-900">Designed For Every Traveller.</span>
            </h2>
          </motion.div>
          ...
          {steps.map((item, index) => (
            ...
            >
              ...
              <div className="flex items-center gap-3 mb-1">
                <div
                  className="
                    ...
                    shadow-[0_0_12px_rgba(200,16,46,0.5)]
                  "
                >
                  {index + 1}
                </div>
              ...
              <div className="mt-auto flex items-center justify-between text-[11px] text-neutral-500 pt-3">
                <span className="uppercase tracking-[0.22em] group-hover:text-red-900 transition-all">
                  {index === 0
                    ? "Start Here"
