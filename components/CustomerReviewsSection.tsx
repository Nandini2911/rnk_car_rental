    ...
    >
      ...
      <div className="relative max-w-5xl mx-auto px-6">
        ...
        <div className="relative max-w-3xl mx-auto">
          {/* gradient border like Vision Pro */}
          <motion.div
            aria-hidden
            className="absolute -inset-[1.5px] rounded-[26px] bg-[conic-gradient(from_180deg,rgba(255,255,255,0.3),rgba(148,27,34,0.55),rgba(0,0,0,0.04),rgba(148,27,34,0.35),rgba(255,255,255,0.2))]"
          ...
          <AnimatePresence custom={direction} mode="wait">
            ...
            >
              ...
              >
                ...
                <p className="text-xs md:text-sm font-semibold tracking-[0.22em] uppercase text-red-800">
                  {active.name}
                </p>
          ...
          {reviews.map((_, i) => (
            <button
              ...
              className={`
                ...
                ${i === index ? "bg-red-700 w-3" : "bg-neutral-300"}
              `}
