...
const containerVariants: Variants = {
  ...
  visible: {
    ...
    transition: {
      ...
      ease: "easeOut",        // 👈 string instead of number[]
      staggerChildren: 0.22,  // one-by-one reveal
    },
  },
};
      ...
      <div className="max-w-6xl mx-auto px-6 py-16 grid grid-cols-1 md:grid-cols-[1.4fr,1fr] gap-10 items-center">
        ...
        >
          <motion.p
            ...
            className="text-[11px] tracking-[0.3em] uppercase text-red-900 mb-3"
          >
          ...
          >
            Redefining{" "}
            <span className="text-red-900">Luxury Car Rental Services</span>
          </motion.h2>
          ...
          >
            ...
            excellence and a deep understanding of the travel industry, they
            laid the foundation of what is today known as{" "}
          ...
          >
            <a
              href="/about"
              className="px-6 py-3 rounded-full bg-black text-white text-[11px] font-semibold uppercase tracking-[0.18em] hover:bg-red-900 transition-all"
            >
              Read More
            </a>

            <div className="flex items-center gap-3">
              <div className="h-12 w-12 rounded-full bg-red-50 flex items-center justify-center border border-red-200">
                <span className="text-red-900 font-semibold text-lg">55+</span>
              </div>
        ...
        {/* RIGHT – IMAGE CARD (OPTIONAL, KEEP / EDIT AS YOU LIKE) */}
        <motion.div
...
<div className="relative h-40  md:h-120 rounded-2xl overflow-hidden bg-neutral-900">
            ...
            <div className="absolute inset-0 bg-gradient-to-tr from-red-900/70 via-black/30 to-neutral-800" />

            <Image
              src="/intro.jpg" // 👉 replace with your image file
          ...
          <div className="pointer-events-none absolute -inset-6 -z-10 bg-gradient-to-b from-red-900/15 via-transparent to-transparent blur-2xl" />
        </motion.div>
      </div>
    </section>
  );
