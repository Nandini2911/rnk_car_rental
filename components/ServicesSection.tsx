          ...
          <div>
            ...
            <h2 className="text-3xl md:text-4xl font-semibold leading-tight text-white space-y-1">
              ...
              <motion.span variants={slideFromRight} className="block">
                <span className="text-red-900"> Tailored To Every Journey.</span>
              </motion.span>
            </h2>
          </div>
          ...
          {services.map((service, index) => {
            ...
            return (
              ...
              >
                ...
                >
                  {/* BACKGROUND IMAGE (slight parallax on hover via scale) */}
                  <motion.div
                  ...
                  >
                    ...
                    >
                      <div className="flex items-center gap-2">
                        ...
                        <span className="uppercase tracking-[0.22em] text-neutral-200 group-hover:text-red-900 transition-colors">
                          Learn More
                        </span>
                      </div>
